 ...
 * Eventos en P<sub>i</sub>
  ...
  * Diagramas espacio-tiempo:  
     ![Ejemplo de diagrama de eventos en el tiempo](/materials/topic-ds/ssdd_sd/ssdd_sd_diagrama_eventos.svg)
...
#### Algoritmo de Cristian
  ![Algoritmo de Cristian](/materials/topic-ds/ssdd_sd/ssdd_sd_rf_cristian.svg)
...
![Algoritmo de Berkeley](/materials/topic-ds/ssdd_sd/ssdd_sd_rf_berkeley.svg)
...
![Ejemplo de diagrama de eventos](/materials/topic-ds/ssdd_sd/ssdd_sd_diagrama_eventos.svg)
...
+ Ejemplo:
  * Ordenado:
    ...
    ![Ejemplo de eventos vistos de forma ordenada](/materials/topic-ds/ssdd_sd/ssdd_sd_rl_o.svg)
  * No ordenado:
  
    ![Ejemplo de eventos vistos de forma NO ordenada](/materials/topic-ds/ssdd_sd/ssdd_sd_rl_no.svg)
...
![Problema de los relojes lógicos](/materials/topic-ds/ssdd_sd/ssdd_sd_prl.svg)
...
* Ejemplo:
   ...
   ![Ejemplo de relojes vectoriales](/materials/topic-ds/ssdd_sd/ssdd_sd_rv.svg)
